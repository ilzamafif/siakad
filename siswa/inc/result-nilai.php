...
if (isset($_POST['result'])) {
  ...
  if (empty(trim($mapel))) {
    ...
    echo location(base('siswa/lihat-nilai'));
  } else {
...
?>
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        $(".row > .col-sm-6:first").append(' <a href="<?= base('siswa/lihat-nilai'); ?>" class="btn btn-primary">Kembali</a>');
...
<?php
  ...
  redirect(base('siswa/lihat-nilai'));
}
