...
$no = 1;
$data = gabung('tbl_absensi', 'tbl_siswa', 'tbl_absensi.idg = tbl_siswa.nis', "tbl_absensi.idg='$id' ORDER BY tbl_absensi.id DESC");
...
<script type="text/javascript" async="true">
  $(document).ready(function() {
    ...
    $(".dataTables_length, #list-data_info").css({
      'display': 'none'
    });
      ...
      <div class="panel panel-default">
        <div class="panel-heading" style="text-align:center;">
          ...
          <p>
            ...
            NIS anda adalah <strong><?= $x->nis; ?></strong>
          </p>
