  ...
  <table class="table table-bordered table-striped" id="list-data">
    ...
    <?php while ($g = mysqli_fetch_object($sqlg)) : ?>
      ...
      <tr>
        ...
        <td class="ctr">
          <a href="absensi-kelas-siswa/<?= $g->id; ?>" class="btn btn-default">Lihat</a>
        </td>
        <td class="ctr">
          <a href="absensi-mata-pelajaran-siswa/<?= $g->id; ?>" class="btn btn-default">Lihat</a>
        </td>
...
<div class="col-md-4">
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      <ul class="list-group">
        <li class="list-group-item">1. Pilih Nama siswa yang akan dilihat absensi</li>
        ...
        <li class="list-group-item">
          ...
          <p>
          Absen kelas : Melihat berapa kali siswa masuk ke dalam kelas yang terjadwalkan <br>
          Absen mapel : Melihat berapa kali siswa masuk dalam mata pelajaran yang terjadwalkan <br>
        </p>
        </li>
      </ul>
    </div>
