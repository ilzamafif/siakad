...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    // $("#list-data_wrapper > .row:first-child > .col-sm-6:first-child").append('<a href="<?= base('siswa/download-legger'); ?>" class="btn btn-primary">Preview Legger</a>');
  });
</script>
<div class="col-md-12">
