          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown data-utama">
              ...
              <ul class="dropdown-menu menu-data">
                ...
                <li><a href="<?= base('waka/jadwal-kelas'); ?>">Data Jadwal Per Kelas</a></li>
                <!-- <li><a href="<?= base('waka/jadwal'); ?>">Data Jadwal Per Hari</a></li>
                <li><a href="<?= base('waka/jadwal'); ?>">Jadwal Guru Mengajar</a></li> -->
